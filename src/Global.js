export var Global = {
    ...
    matomoBackoffice: "http://10.10.5.151/index.php?module=CoreHome&action=index&date=yesterday&period=day&idSite=4#?period=day&date=yesterday&category=Dashboard_Dashboard&subcategory=1"
}
